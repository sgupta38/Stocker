...
def findSharePrice(url):
    ...
    nseElems = soup.select('body > div.container.container--game.wrapper.clearfix > div.content-region.region--full.game-count.full-width > div > div > h3')
    #print('counter: '+ nseElems[0].text.strip())
